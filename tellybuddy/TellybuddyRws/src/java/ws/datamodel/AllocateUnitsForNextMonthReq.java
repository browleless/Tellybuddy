 ...
 * @author tjle2
 */
public class AllocateUnitsForNextMonthReq {
    ...
    public AllocateUnitsForNextMonthReq() {
    }

    public AllocateUnitsForNextMonthReq(String username, String password, Subscription subscription, Integer dataUnits, Integer smsUnits, Integer talktimeUnits) {
