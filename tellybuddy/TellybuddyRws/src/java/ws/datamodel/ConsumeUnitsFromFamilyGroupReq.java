 ...
 * @author tjle2
 */
public class ConsumeUnitsFromFamilyGroupReq {
    ...
    public ConsumeUnitsFromFamilyGroupReq() {
    }

    public ConsumeUnitsFromFamilyGroupReq(String username, String password, Integer dataUnits, Integer smsUnits, Integer talktimeUnits, Subscription subscription, Customer customer, FamilyGroup familyGroup) {
