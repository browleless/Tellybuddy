 ...
 * @author kaikai
 */
public class AllocateAddOnUnitsForCurrentMonthReq {
    ...
    public AllocateAddOnUnitsForCurrentMonthReq() {
    }

    public AllocateAddOnUnitsForCurrentMonthReq(String username, String password, Subscription subscription, Integer dataUnits, Integer smsUnits, Integer talktimeUnits) {
